...
(window.webpackJsonp = window.webpackJsonp || []).push([
  [0],
  {
    ...
    MuzD: function (vdwB, d, $) {
      ...
      function download() {
        ...
        if (Data.checkDownloadSupport()) {
          ...
          el.setAttribute("download", "my-basic-app");
          el.click();
        } else {
      ...
      /** @type {string} */
      that.SAVE_IMAGE_DOWNLOAD_SELECTOR = "#image-download";
      /** @type {string} */
      ...
      Tween.prototype._setupRunTab = function (indent) {
        ...
        return (
          (opts.defaultImage = key),
          (opts.activeImage = index),
    ...
    V6Ve: function (blob, name, universe) {
      ...
      blob.exports =
        universe.p +
        "images/cursor-pen-red.91a6beea49d236d86b247495956bdd65.cur";
    },
    ...
    iapb: function (blob, name, universe) {
      ...
      blob.exports =
        universe.p +
        "images/runjump-background.4b408dc909805d9b99e895ff02063448.png";
    },
